...
Stores compact recent user topics instead of huge assistant outputs or raw shell commands.
"""
...
from .util import now_ts, tokenize
...
class SessionMemory:
    ...
    def _compress(self, role: str, content: str) -> str:
        ...
        if role == "assistant":
            # Keep only a compact assistant topic, not the whole multi-line response.
